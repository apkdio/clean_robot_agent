...
_ROBOT_BOUNDARY = [
    ...
    # 带主体的简短表达（对照裸表达，帮分类头区分主体词）
    "扫地机器人能修吗", "扫地机器人怎么设置定时清扫",
]
...
# ── 短口语维修类 robot 样本（"维修"裸词被分类器误判 other，补样本）────────

_ROBOT_REPAIR = [
    "维修", "怎么维修", "需要维修", "维修一下", "帮我修一下",
    "能维修吗", "可以维修吗", "机器维修", "机器人维修", "扫地机维修",
]
...
_OTHER = [
    ...
    # 网络/办公设备（补充测试暴露的缺失类别）
    "路由器总是断网怎么办", "路由器WiFi信号弱怎么办", "路由器怎么重启", "路由器连不上网",
    "打印机无法打印怎么处理", "打印机卡纸怎么办", "打印机连不上电脑", "打印机怎么加墨",
    "相机镜头怎么清洁", "相机拍出来模糊怎么办", "相机内存卡读不出来",
    "投影仪画面模糊怎么办", "投影仪连不上手机", "投影仪亮度不够",
    # 燃气/汽车
    "燃气灶火苗很小怎么办", "燃气灶打不着火", "燃气灶怎么清洁",
    "新能源汽车冬天续航下降正常吗", "电动车充电慢怎么办", "汽车冬天启动困难",
    # 短口语维修的领域外对照（避免"维修"裸词被拉偏到 other）
    "汽车维修", "手机维修", "电脑维修", "汽车怎么维修", "手机屏幕维修",
    # 空调/手机强化（缓解"空条""手几"等笔误）
    "空调不制冷咋回事", "空调不凉快了", "手机充不进电怎么办",
    # 任务请求类（帮我XX）
    "帮我查一下天气", "帮我写一份简历", "帮我翻译一段话", "帮我订一张票",
    "推荐一家餐厅", "附近有什么好玩的", "帮我算个数", "帮我找个攻略",
    # 带主体的简短表达（对照裸表达）
    "空调能修吗", "手机怎么设置密码",
]
...
_CASUAL = [
    ...
    # 口语表达（补充测试暴露的缺失）
    "我只是来看看", "好的", "嗯", "哦", "没事了", "随便看看", "路过", "收到",
    "好嘞", "好滴", "行", "可以",
    # 能力咨询/娱乐请求（补充测试暴露的缺失）
    "你可以帮我解决什么问题", "你能帮我解决啥", "讲个笑话", "说个段子", "讲个故事",
]
...
_UNKNOWN = [
    ...
    # 简短歧义表达（缺上下文，补充测试暴露的缺失）
    "能修吗", "怎么设置", "能退吗", "有货吗", "需要换吗",
]
